    ...
    <footer class="bg-slate-900 text-slate-300 py-12 border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <!-- Brand -->
                <div>
                    <span class="text-2xl font-bold text-white mb-4 block">Portfolio.</span>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-blue-400 transition">Projects</a></li>
            ...
            <div class="mt-12 pt-8 border-t border-slate-800 text-center text-xs text-slate-500">
                &copy; <?php echo date('Y'); ?> <?php echo get_option('blogname'); ?>. All rights reserved. Powered by Orion CMS.
            </div>
        </div>
    </footer>
</body>
