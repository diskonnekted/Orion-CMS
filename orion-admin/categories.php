                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150 group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex justify-center space-x-3">
                                        ...
                                        <a href="categories.php?action=delete&term_id=<?php echo $cat->term_id; ?>" onclick="return confirm('Are you sure you want to delete this category?');" class="text-gray-400 hover:text-red-600 transition-colors" title="Delete">
